...
# Create a queue per taxi (suggested naming pattern: "<city>_<taxi>") develop a microservice creating
# a fanout exchange, and bind it to all taxi queues. Consume messages from the "notifications" queue;
